...
export interface DAOCoinRequest {
  ...
  OperationType: string;
  // TODO: remove this, but autogenerated stuff is handling uint256's wrong. should be "Hex" types
...
export interface TransferDAOCoinRequest {
  ...
  // TODO: autogenerated types are making uint256's number[] when we need them to be Hex types.
